...
import com.jyd.microservice.currencyexchangeservice.repository.CurrencyExchangeRepository;
...
public class CurrencyExchangeController {
    ...
    public CurrencyExchange retrieveValue(@PathVariable String from, @PathVariable String to){
        //CurrencyExchange currencyExchange = new CurrencyExchange(1000L, from, to, BigDecimal.valueOf(200));
